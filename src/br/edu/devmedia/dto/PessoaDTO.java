...
public class PessoaDTO implements Comparable<PessoaDTO> {
	...
	public PessoaDTO(Long idPessoa, String nome, EnderecoDTO endereco, Long cpf, Character sexo, Date dataNascimento) {
	...
	public PessoaDTO(String nome, EnderecoDTO endereco, Long cpf, Character sexo, Date dataNascimento) {
		this(null, nome, endereco, cpf, sexo, dataNascimento);
	}
	
	//Métodos
	public String[] getArrayString(){
        return new String[]{String.valueOf(idPessoa), nome, String.valueOf(sexo).toUpperCase(), String.valueOf(cpf),
