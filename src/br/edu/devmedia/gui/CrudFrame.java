...
public class CrudFrame extends javax.swing.JFrame {
    ...
    private void alimentarVariaveis() throws ParseException, PersistenciaException {
        ...
        cpf = !ctCpf.getText().replaceAll("[^0-9]", "").equals("") ? Long.valueOf(ctCpf.getText().replaceAll("[^0-9]", "")) : null;
    ...
    private void initComponents() {
        ...
        btExcluido = new javax.swing.JButton();
        ...
        btExcluido.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        btExcluido.setText("Excluidos");
        btExcluido.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btExcluidoActionPerformed(evt);
            }
        });
    ...
    private void pExcluidosComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_pExcluidosComponentShown
        //pgPrincipal.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void pExcluidosComponentHidden(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_pExcluidosComponentHidden
        if (!pExcluidos.isShowing()) {
            pgPrincipal.remove(pExcluidos);
        }
    }//GEN-LAST:event_pExcluidosComponentHidden

    private void btExcluidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluidoActionPerformed
        pgPrincipal.addTab("Pessoas Excluidas", pExcluidos);
        pgPrincipal.setSelectedComponent(pExcluidos);
        carregarTabelaExcluidos();
    }//GEN-LAST:event_btExcluidoActionPerformed
    ...
    private void ctCpfKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ctCpfKeyReleased
        campoValido(lbCpf, ctCpf.getText().trim().length() == 14);
    ...
    private javax.swing.JButton btExcluido;
